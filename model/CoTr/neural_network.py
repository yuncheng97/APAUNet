...
from random_stuff import no_op
from to_torch import to_cuda, maybe_to_torch
...
class SegmentationNetwork(NeuralNetwork):
    ...
    def predict_3D(self, x: np.ndarray, do_mirroring: bool, mirror_axes: Tuple[int, ...] = (0, 1, 2),
        ...
        if len(mirror_axes):
            ...
            if self.conv_op == nn.Conv3d or self.conv_op == ResTranUnet.Conv3d_wd:
