...
def main():
    ...
    data_dir    = os.path.join(train_config['data_path'], train_config['dataset'], 'nnUNetData_plans_v2.1_stage1')
    # data_dir    = os.path.join(train_config['data_path'])
    ...
    # val_ids     = ['liver_129.npz', 'liver_45.npz', 'liver_88.npz', 'liver_26.npz', 'liver_85.npz', 'liver_115.npz', 'liver_103.npz', 'liver_1.npz', 'liver_18.npz', 'liver_83.npz', 'liver_87.npz', 'liver_7.npz', 'liver_11.npz', 'liver_2.npz', 'liver_98.npz', 'liver_74.npz', 'liver_123.npz', 'liver_102.npz', 'liver_54.npz', 'liver_77.npz', 'liver_104.npz', 'liver_97.npz', 'liver_14.npz', 'liver_110.npz', 'liver_32.npz', 'liver_75.npz']
    train_ids   = []
    for idx in ids:
        if idx in val_ids:
            continue
